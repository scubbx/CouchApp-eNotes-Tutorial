.. CouchApp Tutorial documentation master file, created by
   sphinx-quickstart on Sun Nov 27 21:28:43 2011.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

.. highlight:: js

Welcome to the CouchApp Tutorial!
=================================
...
The complete code of the example eNotes CouchApp we will create :download:`can be downloaded here: enotes.zip </_downloads/enotes.zip>`.
